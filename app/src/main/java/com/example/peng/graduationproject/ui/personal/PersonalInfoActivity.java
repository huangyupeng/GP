...
public class PersonalInfoActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2) {
            ...
            try{
                ...
                String filepath=Constants.FILE_DIRECTORY + "/" + currentUser.getMobile() + "/face.jpg";
    ...
    public void startPhotoZoom(Uri uri) {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(new File(Constants.FILE_DIRECTORY + "/" + currentUser.getMobile(), "face.jpg")));
